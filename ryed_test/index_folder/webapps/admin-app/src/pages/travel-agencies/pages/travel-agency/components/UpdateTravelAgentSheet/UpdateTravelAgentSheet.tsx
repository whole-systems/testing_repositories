...
import { useUpdateTravelAgentSheet } from './hooks/useUpdateTravelAgentSheet';
...
export const UpdateTravelAgentSheet = ({
  travelAgentId,
}: {
  travelAgentId: string;
}) => {
  const { data, handlers } = useUpdateTravelAgentSheet(travelAgentId);
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <SheetHeader>
            <SheetTitle>Update Travel Agent</SheetTitle>
          </SheetHeader>

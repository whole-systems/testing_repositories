...
import { useUpdateTravelAgencySheet } from './hooks/useUpdateTravelAgencySheet';
import { VatPicker } from '@/components/VatPicker/VatPicker.tsx';
import { Switch } from '@ryed/ui';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/Select/Select';

export const UpdateTravelAgencySheet = ({ agencyId }: { agencyId: string }) => {
  const { data, handlers } = useUpdateTravelAgencySheet(agencyId);
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <SheetHeader>
            <SheetTitle>Update Travel Agency</SheetTitle>
          </SheetHeader>

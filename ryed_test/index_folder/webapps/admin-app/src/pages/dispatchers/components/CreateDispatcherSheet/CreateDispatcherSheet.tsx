...
import { useCreateDispatcherSheet } from './hooks/useCreateDispatcherSheet';
...
export const CreateDispatcherSheet: FC = () => {
  const { data, handlers } = useCreateDispatcherSheet();
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <SheetHeader>
            <SheetTitle>Create new dispatcher</SheetTitle>
          </SheetHeader>
                      ...
                      <CardContent className="flex flex-col gap-4">
                        ...
                        <div className="my-4  w-full h-full ">
                          ...
                          <GooglePlaceAutocomplete
                            ...
                            value={data.location?.locationNameLocalized ?? ''}
                            name="location"
